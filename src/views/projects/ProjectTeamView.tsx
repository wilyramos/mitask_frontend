...
export default function ProjectTeamView() {
    ...
    const queryClient = useQueryClient() // para invalidar el q uery y actualizar la paginap
    ...
    if (data) return (
        <>
            ...
            <p className='text-2xl font-light text-gray-500 mt-5'>Equipo de trabajo para este proyecto</p>
